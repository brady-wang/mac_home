...
const URL_PATHINFO  = 1; // PATHINFO 模式
const URL_REWRITE   = 2; // REWRITE 模式
...
defined('APP_PATH')     or define('APP_PATH',      ROOT_PATH.'Application/'); // 应用目录
...
defined('ADDON_PATH')   or define('ADDON_PATH',    APP_PATH.'Addon');         // 插件控制器目录
defined('RUNTIME_PATH') or define('RUNTIME_PATH',  ROOT_PATH.'Runtime/');     // 系统运行时目录
...
defined('TMPL_PATH')    or define('TMPL_PATH',     ROOT_PATH.'Template/');    // 模板文件目录
