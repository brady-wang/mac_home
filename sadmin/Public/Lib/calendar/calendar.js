    ...
    calendar: function(c) {
        function r() {
            $("#" + c.controlId).find(".tabD a").mouseup(function() {
                ...
                if (c.showtime) {
                    var hour = Number($("#" + c.controlId).find(".t_hour").val());
                    var min = Number($("#" + c.controlId).find(".t_minute").val());
                    var sec = Number($("#" + c.controlId).find(".t_second").val());
                    a += " " + (hour < 10 ? "0" + hour: hour) + ":" + (min < 10 ? "0" + min: min) + ":" + (sec < 10 ? "0" + sec: sec);
                }
                n.val(a);
        ...
        k += "      </div>";
        k += "    </div>";
        k += "    <div class='calBottom'><div class='calTime'></div><span class='clear'>清除</span>";
        k += "    </div>";
        k += "  </div>";
        k += "</div>";
        $("body").append(k);
        r();
        $("#" + c.controlId).find(".clear").click(function() {
            n.val("");
            $("#" + c.controlId).hide();
        });
        ...
        function() {
            if ($("#" + c.controlId + ":hidden").length != 0) {
                ...
                d = $("#" + c.controlId).outerWidth();
                //b = $("#" + c.controlId).height();
                //b = $("#" + c.controlId).find(".calTitle").height() + $("#" + c.controlId).find(".calContent").height();
                b = $("#" + c.controlId).find(".calTitle").height() + $("#" + c.controlId).find(".calContent").height() + $("#" + c.controlId).find(".calBottom").height();
                $("#" + c.controlId).find(".calTime").css("display", "none");
                if (c.showtime) {
                    $("#" + c.controlId).find(".calTime").css("display", "inline-block");
                    var html = "<select class='t_hour'>";
                    var tm = new Date();
                    for (var idx=0; idx<24; idx++) {
                        html += "<option value=" + idx + (idx == tm.getHours() ? " selected " : "") + ">" + idx + "</option>";
                    }    
                    html += "</select>&nbsp;&nbsp;";
                    html += "<select class='t_minute'>";
                    for (var idx=0; idx<60; idx++) {
                        html += "<option value=" + idx + (idx == tm.getMinutes() ? " selected " : "") + ">" + idx + "</option>";
                    }    
                    html += "</select>&nbsp;&nbsp;";
                    html += "<select class='t_second'>";
                    for (var idx=0; idx<60; idx++) {
                        html += "<option value=" + idx + (idx == tm.getSeconds() ? " selected " : "") + ">" + idx + "</option>";
                    }    
                    html += "</select>&nbsp;&nbsp;";
                    $("#" + c.controlId).find(".calTime").html(html);
                    //b += $("#" + c.controlId).find(".calBottom").height();
                }
                a.width(0);
                a.height(0);
                a.show().animate({
