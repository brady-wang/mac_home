 ...
 * 配置不同环境的参数，例如数据库配置等
 * 'APP_STATUS' 为 'develop' 加载本配置(开发环境)
 */
return array(

    // 数据库配置信息
    'DB_TYPE' => 'mysql', // 数据库类型
    'DB_HOST' => '192.168.7.26', // 服务器地址
    'DB_NAME' => 'sadmin_dev', // 数据库名
    'DB_USER' => 'root', // 用户名
    'DB_PWD' => 'sdf*2018', // 密码
    'DB_PORT' => '3306', // 端口
    ...
    // 资源服务器访问地址
    'RESOURCE_SERVER_IPHOST' => 'http://192.168.7.26',
    'RESOURCE_SERVER_PORT' => 8081,
    // 资源服文件传输地址
    'RESOURCE_API_IPHOST' => '192.168.7.26',
    'RESOURCE_API_PORT' => 8081,

    // 分享后台地址
    'SHARE_SERVER_IPHOST' => '192.168.7.26',
    'SHARE_SERVER_PORT' => 8082,

    // 白名单服务器地址
    'WHITELIST_SERVER_IPHOST' => '192.168.7.26',
    'WHITELIST_SERVER_PORT' => 8085,

    // 落地页服务器地址
    'LANDPAGE_SERVER_IPHOST' => '192.168.7.26',
    'LANDPAGE_SERVER_PORT' => 8084,
    ...
    'ACT_API_CONFPORT' => '18603',

    'ACT_API1_CONFURL' => 'http://192.168.7.26',
    'ACT_API1_CONFPORT' => '18603',

    'ACT_API2_CONFURL' => 'http://192.168.7.26',
    'ACT_API2_CONFPORT' => '18603',
