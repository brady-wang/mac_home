...
class StatUserRegisterModel extends Model
{
    /**
     * 取得注册来源统计数据
     * @author liyao
     */
    public function queryStatUserRegisterData($where, $pageParam, $field = "*")
    {
        $ret = array(
        ...
        try {
            ...
            set_exception(__FILE__, __LINE__, "[queryStatUserRegisterData] select failed: ".$e->getMessage());
     ...
     * @author liyao
     */
    public function queryStatUserRegisterChartData($where, $chartMap, $stime, $etime)
    {
        $ret = array(
            'code' => ERRCODE_SUCCESS,
            'msg' => "",
        ...
        try {
            ...
            set_exception(__FILE__, __LINE__, "[queryStatUserRegisterChartData] select failed: ".$e->getMessage());
            $ret['code'] = ERRCODE_DB_SELECT_ERR;
            $ret['msg'] = $e->getMessage();
            return $ret;
        }
     ...
     * @author liyao
     */
    public function queryStatUserRegisterAllData($where, $field = "*")
    {
        $ret = array(
            'code' => ERRCODE_SUCCESS,
            'msg' => "",
        ...
        try {
            ...
            set_exception(__FILE__, __LINE__, "[queryStatUserRegisterAllData] select failed: ".$e->getMessage());
            $ret['code'] = ERRCODE_DB_SELECT_ERR;
            $ret['msg'] = $e->getMessage();
            return $ret;
        }
     ...
     * @author liyao
     */
    public function insertStatUserRegister($data, $gameid, $curDate)
    {
        try {
            ...
            set_exception(__FILE__, __LINE__, "[insertStatUserRegister] insert failed ".$e->getMessage());
        }
    }
}
