...
class GameWhiteListModel extends Model
{
    // 白名单类型
     ...
     * @author Carter
     */
    public function queryGameWhiteUserByAttr($gameId, $attr)
    {
        $ret = array(
     ...
     * @author Carter
     */
    public function queryAllGameWhiteListByAttr($gameId)
    {
        $ret = array(
            'code' => ERRCODE_SUCCESS,
            'msg' => "",
     ...
     * @author Carter
     */
    public function insertGameWhiteList($gameId, $attr)
    {
        $ret = array(
            'code' => ERRCODE_SUCCESS,
            'msg' => "",
     ...
     * @author Carter
     */
    public function deleteGameWhiteList($id)
    {
        $ret = array(
            'code' => ERRCODE_SUCCESS,
            'msg' => "",
