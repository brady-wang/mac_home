...
<link rel="stylesheet" type="text/css" href="/themes/lib/jquery_pic_clipping/css/ycbootstrap.css">
<!--<link rel="stylesheet" type="text/css" href="/themes/lib/jquery_pic_clipping/css/reset.css">-->
<script src="/themes/lib/jquery_pic_clipping/plugins/cover_js/iscroll-zoom.js" type="text/javascript" charset="utf-8"></script>
<script src="/themes/lib/jquery_pic_clipping/plugins/cover_js/hammer.js" type="text/javascript" charset="utf-8"></script>
<script src="/themes/lib/jquery_pic_clipping/plugins/cover_js/lrz.all.bundle.js" type="text/javascript" charset="utf-8"></script>
<script src="/themes/lib/jquery_pic_clipping/plugins/cover_js/jquery.photoClip.min.js" type="text/javascript" charset="utf-8"></script>
<!--主体内容开始-->
<div id="main" class="col-md-10">
    <div class="page-header">
        <h2>设置 <small>Face </small></h2>
        <p class="text-primary">头像</p>
    </div>
    <div class="panel">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0;">
                                ...
                                <div class="ycupload-mainbox">
                                    <div class="ycupload-main1" style="overflow:hidden;padding-left:25px;">
                                        <span
                                            style="float:left;color:#ff5a5a;font-size:14px;line-height:60px;font-weight:900;margin-right:7px;">
								&middot;
							</span>
								...
								上传头像
                                    ...
                                    <div  style="min-height:1px;">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right:0;padding-left:36px;">
                                                    ...
                                                    <div style="min-height:1px;line-height:160px;text-align:center;position:relative;" ontouchstart="">
                                                        ...
                                                        <div id="view" style="width:300px;height:300px;" style="background-image:url(<?php echo $user_info['face']; ?>)" title="请上传 300*300 的封面图片">
                                                            <?php
                                                                if(!empty($user_info['face'])){
                                                                    echo "<img src=". $user_info['face'].">";
                                                                }
                                                            ?>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right:0;padding-left:36px;">
                                                    <button class="btn btn-default" id="submit_face_img">提交</button>
                                                </div>
                                            </div>
                                        </div>
...
//            img.setAttribute('src', dataURL);
    ...
    $("#submit_face_img").click(function(){
        var face  = $("#view").css("backgroundImage").replace('url("','').replace('")','');
        var data = {};
        data.image = face;
        $.ajax({
            url:'/admin/Setting/upload_face',
            data:data,
            dataType:"json",
            type:"post",
